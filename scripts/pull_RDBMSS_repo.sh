...
cd playground && git pull && cd ..
cd users && git pull && cd ..
cd support && git pull && cd ..
cd location && git pull && cd ..
cd store && git pull && cd ..
cd wallet && git pull && cd ..
cd payments && git pull && cd ..
